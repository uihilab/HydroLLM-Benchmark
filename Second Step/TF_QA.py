...
def generate_FITB(text):
    ...
    prompt = f"""
        ...
        - Based on the main content, generate **2 True False questions** that cover the key topics and concepts discussed in the article.
...
with open("TF_dataset_test1.csv", mode="w", newline="") as file:
