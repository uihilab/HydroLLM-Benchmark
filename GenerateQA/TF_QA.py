...
def generate_FITB(text):
    ...
    prompt = f"""
        ...
        - Based on the main content, generate **1 True False question** that cover the key topics and concepts discussed in the article. 
        - **Do not** reference specifics such as locations, times, or use phrases like "in this study," "the authors," "this research," etc.        - Ensure that questions are **self-contained** and **standalone**, meaning they do not require external context to be understood.
        - **Do not** generate questions other than true-false questions. 
...
with open("", mode="w", newline="") as file:
    ...
    for i in range(0, len(article_data['Content'])):
