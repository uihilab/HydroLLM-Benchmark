...
def generate_FITB(text):
    ...
    prompt = f"""
        ...
        - Based on the main content, generate **1 fill in the blank questions** that cover the key topics and concepts discussed in the article.
...
with open("", mode="w", newline="") as file:
    ...
    for i in range(start, len(article_data['Content'])+1):
