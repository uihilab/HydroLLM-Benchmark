...
def generate_FITB(text):
    ...
    prompt = f"""
        ...
        - Based on the main content, generate **20 different True False questions** that cover the key topics and concepts discussed in the text. 
    ...
    response = openai.chat.completions.create(
        model="gpt-4o-mini",
        messages=[
            {"role": "system", "content": "You are an expert on generating questions and answers from the given text."},
...
with open("TF_book_dataset.csv", mode="w", newline="", encoding='utf-8') as file:
